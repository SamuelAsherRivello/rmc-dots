...
namespace RMC.Playground2D.Shared.UI
{
    ...
    public class MainUI: MonoBehaviour
    {
        ...
        //  Properties ------------------------------------
        public Label Score01Label { get { return _uiDocument?.rootVisualElement?.Q<Label>("Score01Label");} }
        public Label Score02Label { get { return _uiDocument?.rootVisualElement?.Q<Label>("Score02Label");} }

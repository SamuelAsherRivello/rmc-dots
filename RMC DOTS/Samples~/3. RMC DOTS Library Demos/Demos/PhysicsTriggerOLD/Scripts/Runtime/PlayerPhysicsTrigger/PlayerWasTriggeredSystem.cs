...
namespace RMC.DOTS.Demos.PhysicsTriggerOLD
{
    ...
    public partial struct PlayerWasTriggeredSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            foreach (var (playerTag, goalWasReachedTag, entity) 
                     in SystemAPI.Query<PlayerTag, PlayerWasTriggeredTag>().
                         WithEntityAccess())
            {
            ...
            foreach (var (playerTag, physicsTriggerOutputTag, entity) 
                     in SystemAPI.Query<PlayerTag, PhysicsTriggerOutputComponent>().
                         WithEntityAccess())
            {
